...
async function main() {
  ...
  if (canvasTab) {
    ...
    const nodeEl = await page.$('div:has-text("Cron Trigger")') || await page.$('div.cursor-pointer.rounded-xl');
    if (nodeEl) {
      console.log("Found node, clicking...");
      await nodeEl.click();
      ...
      console.log("Captured 106_node_inspector_dag_connections_verified.png successfully!");
    } else {
