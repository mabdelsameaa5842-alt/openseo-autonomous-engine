      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              <div className="h-6 w-6 rounded-lg bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center border border-zinc-200 dark:border-zinc-700/50 shrink-0">
              ...
              />
              <ChevronDown
                className={`h-4 w-4 text-zinc-500 dark:text-zinc-400 shrink-0 transition-transform duration-200 ${
            ...
            {isDropdownOpen && (
              ...
              >
                <div className="px-3 py-2 text-[11px] font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                  <span>{isRtl ? "مسارات الأتمتة المتاحة" : "Available Workflows"}</span>
                  <span className="font-mono text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded-md">
                    ...
                    >
                      <div className="flex items-center gap-2.5 truncate">
                        ...
                        <div className="truncate">
                          ...
                          <div className="text-[11px] text-zinc-600 dark:text-zinc-400 flex items-center gap-2 mt-0.5">
          ...
          <div className="relative">
            ...
            {isNewMenuOpen && (
              <div
                ...
                style={{ filter: "drop-shadow(0 20px 25px rgb(0 0 0 / 0.25))" }}
              >
                <div className="px-2 py-1.5 text-[10px] font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider">
