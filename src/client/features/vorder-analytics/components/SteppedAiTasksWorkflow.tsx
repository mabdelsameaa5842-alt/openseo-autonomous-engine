...
const ARABIC_STEP_DESCRIPTIONS: Record<number, string> = {
  ...
  6: "تحديث خريطة الموقع وتفريغ كاش الحافة الفوري ليصبح المقال متاحاً فورياً لعناكب محركات البحث مع رفع إجمالي الروابط إلى 470 رابطاً.",
...
const STEP_DATA_PIPELINE: Record<number, { input: string; output: string; tags: string[] }> = {
  ...
  6: {
    ...
    output: "خريطة موقع محدثة بـ 470 رابطاً وتفريغ الكاش",
    tags: ["sitemap.xml", "470 URLs Active", "Edge Purge: 4ms"],
  },
  7: {
  ...
  9: {
    ...
    tags: ["Cloudflare D1 Ledger", "Edge Cache Verified", "Sitemap 470 Active", "100% Secure"],
  },
};
