...
import { SmokeParticleSystem } from '../engine/smokeParticles.js';

const unlockAudio = () => {};
const vscode = { postMessage: (_msg: any) => {} };
...
export function OfficeCanvas({
  ...
  const smokeSystemRef = useRef<SmokeParticleSystem>(new SmokeParticleSystem());
