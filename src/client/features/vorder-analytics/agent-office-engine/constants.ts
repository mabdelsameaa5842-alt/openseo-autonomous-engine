...
// ── Autonomous Office Cycle ──────────────────────────────────
export const AUTO_ON_FACING_DEPTH = 1;
...
export const HUE_SHIFT_MIN_DEG = 15;
export const HUE_SHIFT_RANGE_DEG = 330;
export const INACTIVE_SEAT_TIMER_MIN_SEC = 30;
export const INACTIVE_SEAT_TIMER_RANGE_SEC = 60;
export const WAITING_BUBBLE_DURATION_SEC = 10;
