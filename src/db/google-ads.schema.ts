...
// Selected Google Ads customer per project. OAuth credentials stay in
// Better Auth's account table under the dedicated "google-ads" provider.
export const googleAdsConnections = sqliteTable(
  "google_ads_connections",
  {
    ...
    customerDescriptiveName: text("customer_descriptive_name").notNull(),
